...
let usage = """
Usage:   \(ProgramName) [-c <current JSON>] [--overwrite] -o (\(MetadataCollector.OutputType.allCasesString)) [-i (\(MetadataCollector.InputType.allCasesString)) (\(CollectionType.allCasesString)) <input files ...>]
